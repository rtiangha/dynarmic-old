...
#endif
    puts("\t((void (*)(void*, void*, int *))code)((void*)putchar, (void*)getchar, stack);\n"
         "}");
}
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        if (mode == 0) {
            static int stack[128 * 1024];
            bf.getCode<void (*)(const void*, const void*, int*)>()(
                reinterpret_cast<const void*>(putchar), reinterpret_cast<const void*>(getchar),
                stack);
        } else {
