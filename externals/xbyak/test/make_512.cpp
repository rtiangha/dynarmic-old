...
class Test {
    ...
    const char* get(uint64_t type) const {
        ...
        case VM32Z_K:
            if (idx & 1)
                return isXbyak_ ? "ptr [64+zmm10*8+r9] | k6" : "[64+zmm10*8+r9]{k6}";
        ...
        case M_xword:
            return isXbyak_ ? "ptr [eax+32]" : "oword [eax+32]";
        case M_yword:
            return isXbyak_ ? "yword [eax+32]" : "yword [eax+32]";
        case MY_1to4:
...
public:
    ...
    */
    ...
    void putMisc1() {
        ...
        {
            const char* tbl[] = {
                "vbroadcastss", "vpbroadcastb", "vpbroadcastw", "vpbroadcastd", "vpbroadcastq",
            };
            for (size_t i = 0; i < NUM_OF_ARRAY(tbl); i++) {
        ...
        {
            const char* tbl[] = {"vpmaskmovd", "vpmaskmovq"};
            for (size_t i = 0; i < NUM_OF_ARRAY(tbl); i++) {
    ...
    void put512_Y_XM() {
        const struct Tbl {
            ...
            {"vpmovsxbw", false}, {"vpmovsxbd", true}, {"vpmovsxbq", true},
            {"vpmovsxwd", false}, {"vpmovsxwq", true}, {"vpmovsxdq", false},

            {"vpmovzxbw", false}, {"vpmovzxbd", true}, {"vpmovzxbq", true},
            {"vpmovzxwd", false}, {"vpmovzxwq", true}, {"vpmovzxdq", false},
        };
        for (size_t i = 0; i < NUM_OF_ARRAY(tbl); i++) {
            const Tbl& p = tbl[i];
    ...
    void putGather() {
        ...
        const struct Tbl {
            ...
            {"vpgatherdd", xx_yy_zz}, {"vpgatherdq", xx_yx_zy}, {"vpgatherqd", xx_xy_yz},
            {"vpgatherqq", xx_yy_zz}, {"vgatherdps", xx_yy_zz}, {"vgatherdpd", xx_yx_zy},
            {"vgatherqps", xx_xy_yz}, {"vgatherqpd", xx_yy_zz},
        };
        for (size_t i = 0; i < NUM_OF_ARRAY(tbl); i++) {
            const Tbl& p = tbl[i];
            switch (p.mode) {
    ...
    void putScatter() {
        ...
        const struct Tbl {
            ...
            {"vpscatterdd", xx_yy_zz}, {"vpscatterdq", xx_xy_yz},
            {"vpscatterqd", xx_yx_zy}, {"vpscatterqq", xx_yy_zz},

            {"vscatterdps", xx_yy_zz}, {"vscatterdpd", xx_xy_yz},
            {"vscatterqps", xx_yx_zy}, {"vscatterqpd", xx_yy_zz},
        };
        for (size_t i = 0; i < NUM_OF_ARRAY(tbl); i++) {
            const Tbl& p = tbl[i];
            switch (p.mode) {
    ...
    void putVpcmp() {
        ...
        const struct Tbl {
            ...
            {"vpcmpb", 0},      {"vpcmpub", 0},      {"vpcmpw", 0},      {"vpcmpuw", 0},
            {"vpcmpd", M_1to4}, {"vpcmpud", M_1to4}, {"vpcmpq", M_1to2}, {"vpcmpuq", M_1to2},
        };
        for (size_t i = 0; i < NUM_OF_ARRAY(tbl); i++) {
            const Tbl& p = tbl[i];
    ...
    void putVtest() {
        ...
        const struct Tbl {
            ...
            {"vptestmb", 0},  {"vptestmw", 0},  {"vptestmd", M_1to4},  {"vptestmq", M_1to2},

            {"vptestnmb", 0}, {"vptestnmw", 0}, {"vptestnmd", M_1to4}, {"vptestnmq", M_1to2},
        };
        for (size_t i = 0; i < NUM_OF_ARRAY(tbl); i++) {
            const Tbl& p = tbl[i];
            const uint64_t* bTbl = p.b == 0 ? b0Tbl : p.b == M_1to4 ? b4Tbl : b2Tbl;
    ...
    void putPerm() {
        ...
        const struct Tbl {
            ...
            {"vpermt2b", 0},      {"vpermt2w", 0},       {"vpermt2d", M_1to4},
            {"vpermt2q", M_1to2}, {"vpermt2ps", M_1to4}, {"vpermt2pd", M_1to2},

            {"vpermi2b", 0},      {"vpermi2w", 0},       {"vpermi2d", M_1to4},
            {"vpermi2q", M_1to2}, {"vpermi2ps", M_1to4},
        };
        for (size_t i = 0; i < NUM_OF_ARRAY(tbl); i++) {
            const Tbl& p = tbl[i];
            const uint64_t* bTbl = p.b == 0 ? b0Tbl : p.b == M_1to4 ? b4Tbl : b2Tbl;
    ...
    void putDisp8N() {
        {
            const int tbl[] = {-129, -128, -127, 0, 1, 64, 65, 127, 128};
            for (size_t i = 0; i < NUM_OF_ARRAY(tbl); i++) {
                char xs[128], ns[128];
                int v = tbl[i];
        ...
        {
            const int tbl[] = {-1024, -512 - 256, -128, -64, -32, -16, -8, -4,  -2,  -1, 0,
...
#ifdef XBYAK64
        put("vfmadd231ps", "zmm8, zmm31, ptr_b[r14+rbp-0x1e4]",
