...
EmitA64::EmitA64(BlockOfCode& code) : code(code) {}

EmitA64::~EmitA64() = default;

std::optional<typename EmitA64::BlockDescriptor> EmitA64::GetBasicBlock(
...
void EmitA64::PushRSBHelper(ARM64Reg loc_desc_reg, ARM64Reg index_reg,
    ...
    code.STR(INDEX_UNSIGNED, loc_desc_reg, code.ABI_SCRATCH1,
    ...
    code.ANDI2R(DecodeReg(index_reg), DecodeReg(index_reg), code.GetJitStateInfo().rsb_ptr_mask,
                code.ABI_SCRATCH1);
...
EmitA64::BlockDescriptor EmitA64::RegisterBlock(const IR::LocationDescriptor& descriptor,
